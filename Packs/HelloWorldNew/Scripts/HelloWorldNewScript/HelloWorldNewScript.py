"""HelloWorldNew Script for Cortex XSOAR (aka Demisto)
...
HelloWorldNew Integration code.
...
def say_hello_command(args: Dict[str, Any]) -> CommandResults:
    ...
    # Check the HelloWorldNew comments from the HelloWorldNew Integration
...
def main():
    try:
        ...
        return_error(f'Failed to execute HelloWorldNewScript. Error: {str(ex)}')
